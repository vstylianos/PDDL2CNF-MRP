...
Note that when encoding MRP scenarios, we have to ensure that the same symbols in both KBs refer to the same predicates. Encode KBa first (which is assumed complete and correct), store all the symbols, and re-use them to encode KBh.
'''
